...
return [
    ...
    'specs' => [
        ...
        'ultrawide_aperture' => [
            ...
            'weight' => 0,  // Don't score separately (informational only)
            'unit' => [
                'value' => 'f/',
                'position' => 'before',   // before | after
                'space' => false           // true => add space, false => no space
        ...
        'macro_aperture' => [
            ...
            'weight' => 0,  // Don't score (informational only)
            'unit' => [
                'value' => 'f/',
                'position' => 'before',   // before | after
                'space' => false           // true => add space, false => no space
        ...
        'stabilization' => [
            ...
            'weight' => 8,  // Increased from 1 - very important!
            'scale' => [
                'ois + eis' => 10,
