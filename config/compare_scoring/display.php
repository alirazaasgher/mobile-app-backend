...
return [
    ...
    'brightness' => [
        'label' => 'Brightness',
        'weight' => 20,
        'hidden' => true, // Weighted score is hidden, but the 3 values will be shown
        'ranges' => [
            ['min' => 2600, 'score' => 10], // Elite HBM (or Peak normalized)
            ['min' => 2000, 'score' => 9],  // High-end Flagship
            ['min' => 1500, 'score' => 8],  // Upper Midrange (Your 1400 nits lands here now)
            ['min' => 1200, 'score' => 7],  // Solid Midrange
            ['min' => 900, 'score' => 6],  // Standard
            ['min' => 700, 'score' => 5],  // Budget Plus
            ['min' => 500, 'score' => 3],  // Entry Level
        ],
        'default' => 2,
    ],
    'brightness_hbm' => [
