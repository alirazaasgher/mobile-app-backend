...
return [
    'label' => 'Display',
     'weights' => [
        'panel_color'    => 0.33, // Panel type, PWM, color depth, contrast
        'brightness'     => 0.25, // HBM full-screen, minimum brightness bonus
        'motion'         => 0.20, // Refresh rate, adaptive, touch sampling
        'sharpness'      => 0.12, // PPI, screen size ratio
        'ergonomics'     => 0.10, // Glass protection, bezels, premium finish
    ],
    'panel_bonus_max' => 15,   // Max bonus points for advanced panel types
    'min_brightness_bonus' => 5, // Night-mode bonus if < 1 nit
    'specs' => [
        'type' => [
            'label' => 'Display Type',
