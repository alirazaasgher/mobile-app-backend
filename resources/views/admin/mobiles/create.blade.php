          ...
          <div class="variant-row border p-4 rounded bg-gray-50 space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" name="sd_card" value="{{ old('name', $mobile->sd_card ?? 'No') }}"
                  class="border rounded w-full p-2">
              </div>
              <div>
                <label class="block font-medium">Ram Type</label>
                <input type="text" name="ram_type" value="{{ old('name', $mobile->ram_type ?? '') }}"
                  class="border rounded w-full p-2">
              </div>
            </div>
            <div class="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" name="storage_type" value="{{ old('name', $mobile->storage_type ?? '') }}"
                  class="border rounded w-full p-2">
              </div>
            </div>
          </div>
