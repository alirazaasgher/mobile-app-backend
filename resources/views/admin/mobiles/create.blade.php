...
<!-- oninput="updateColorCircle('color_0', this.value)" -->
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            $modifierValueUSD = old("variants.{$variantIndex}.price_modifier.{$optionValue}", $existingVariant['price_modifier_usd'] ?? $option['modifier']);
            $modifierValuePKR = old("variants.{$variantIndex}.price_modifier.{$optionValue}", $existingVariant['price_modifier_pkr'] ?? $option['modifier']);
                ...
                <div class="flex-1">
                  ...
                  <div class="flex items-center space-x-2 mt-3">
                    ...
                    <div class="relative w-1/2">
                      ...
                      <input type="number"
                        name="variants[price_modifier_usd][{{ $optionValue }}]"
                        value="{{ $modifierValueUSD ?? '' }}"
                    ...
                    <div class="relative w-1/2">
                      <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 text-sm">₨</span>
                      <input type="number"
                        name="variants[price_modifier_pkr][{{ $optionValue }}]"
                        value="{{ $modifierValuePKR ?? '' }}"
