      ...
      <div class="bg-gray-50 p-4 rounded-lg">
        ...
        <div class="flex flex-wrap gap-1 border-b border-gray-200 mb-6" id="tabs" role="tablist">
          ...
          <button type="button" data-tab="{{ $index }}" class="tab-btn px-4 py-2.5 text-sm font-medium border-b-2 transition-colors
            ...
            role="tab" aria-selected="{{ $loop->first ? 'true' : 'false' }}" aria-controls="tab-{{ $index }}">
            {{ ucfirst($index) }}
              ...
              <div class="flex items-start space-x-3">
                ...
                <div class="flex-1">
                  ...
                  <div class="flex items-center space-x-2 mb-2">
                    ...
                    <select name="variants[ram_type][{{ $optionValue }}]" class="border border-gray-300 rounded-md text-sm px-2 py-1 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                  ...
                  <div class="flex items-center space-x-2 mb-3">
                    ...
                    <select name="variants[storage_type][{{ $optionValue }}]" class="border border-gray-300 rounded-md text-sm px-2 py-1 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    <option value="">Please Select</option>  
                  ...
                  <div class="flex items-center space-x-2 mt-3">
                    ...
                    <div class="relative w-1/2">
                      ...
                      <input type="number" name="variants[price_modifier_usd][{{ $optionValue }}]"
                        value="{{ $modifierValueUSD ?? '' }}" placeholder="0.00" step="0.01" min="0" class="w-full pl-7 pr-3 py-2 text-sm border border-gray-300 rounded-md
                    ...
                    <div class="relative w-1/2">
                      ...
                      <input type="number" name="variants[price_modifier_pkr][{{ $optionValue }}]"
                        value="{{ $modifierValuePKR ?? '' }}" placeholder="0" step="1" min="0" class="w-full pl-7 pr-3 py-2 text-sm border border-gray-300 rounded-md
                                    focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" />
                    </div>
                  </div>
