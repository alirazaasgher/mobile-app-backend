{{-- Sidebar --}}
<aside id="sidebar" class="bg-dark text-white p-3" style="
            width:235px;
            min-height:100vh;
            position:sticky;
            top:0;
  ...
  <ul class="nav nav-pills flex-column gap-1">
    ...
    <li class="nav-item">
      <a href="{{ route('admin.chipsets.create') }}"
        class="nav-link {{ request()->routeIs('admin.chipsets.create') ? 'active' : 'text-white' }}">
        <i class="bi bi-plus-circle me-2"></i>
        Add Chipset
      </a>
    </li>
    <li class="nav-item">
      <a href="{{ route('admin.chipsets.index') }}"
        class="nav-link {{ request()->routeIs('admin.chipsets.index') ? 'active' : 'text-white' }}">
        <i class="bi bi-phone me-2"></i>
        All Chipset
      </a>
    </li>
